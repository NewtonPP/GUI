...
export const {setAtomtypes, setFingerprints,setNetworkLayers, setCalibrationparameters, setActivationFunctions, setScreening,setStateEquations} = DataSlice.actions
